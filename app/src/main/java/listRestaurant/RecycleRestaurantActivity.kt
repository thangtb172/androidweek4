...
import kotlinx.android.synthetic.main.recycle_restaurant.*
import kotlinx.android.synthetic.main.recycle_restaurant.view.*
...
class RecycleRestaurantActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.recycle_restaurant)
